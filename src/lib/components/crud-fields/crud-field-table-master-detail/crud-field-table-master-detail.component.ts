...
@Component({
  ...
  templateUrl: './crud-field-table-master-detail.component.html',
  // changeDetection: ChangeDetectionStrategy.OnPush
})
export class CrudFieldTableMasterDetailComponent extends CrudFieldBaseComponent implements OnInit {
